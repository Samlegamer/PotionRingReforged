...
public class PotionRing
{
	...
	private void client(FMLClientSetupEvent event)
	{
		...
		{
			AccessoriesRendererRegistry.registerNoRenderer(item.get());
		}
		AccessoriesRendererRegistry.registerNoRenderer(BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(MODID, "ring_of_growing")).get().value());
		AccessoriesRendererRegistry.registerNoRenderer(BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(MODID, "ring_of_shrinking")).get().value());
		AccessoriesRendererRegistry.registerNoRenderer(BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(MODID, "ring_of_thinning")).get().value());
		AccessoriesRendererRegistry.registerNoRenderer(BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(MODID, "ring_of_widening")).get().value());
