        ...
        itemModels.itemModelOutput.accept(item,
                ItemModelUtils.tintedModel(ModelTemplates.THREE_LAYERED_ITEM.create(ModelLocationUtils.getModelLocation(item),
                        TextureMapping.layered(
                                Identifier.parse("potionring:item/gold_ring"),
                                Identifier.parse("potionring:item/gem_color"),
                                Identifier.parse("potionring:item/gem_light")), itemModels.modelOutput), ItemModelUtils.constantTint(0xFFFFFFFF),
