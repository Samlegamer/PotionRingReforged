...
public class PotionRing
{
	...
	public static final RegistryObject<Effect> growing = RegistryObject.of(new ResourceLocation("sizeshiftingpotions:growing"), ForgeRegistries.POTIONS);
	public static final RegistryObject<Effect> shrinking = RegistryObject.of(new ResourceLocation("sizeshiftingpotions:shrinking"), ForgeRegistries.POTIONS);
	public static final RegistryObject<Effect> widening = RegistryObject.of(new ResourceLocation("sizeshiftingpotions:widening"), ForgeRegistries.POTIONS);
	public static final RegistryObject<Effect> thinning = RegistryObject.of(new ResourceLocation("sizeshiftingpotions:thinning"), ForgeRegistries.POTIONS);
