...
public class PotionRing
{
	...
	public static final RegistryObject<MobEffect> growing = RegistryObject.of(new ResourceLocation("sizeshiftingpotions:growing"), ForgeRegistries.MOB_EFFECTS);
	public static final RegistryObject<MobEffect> shrinking = RegistryObject.of(new ResourceLocation("sizeshiftingpotions:shrinking"), ForgeRegistries.MOB_EFFECTS);
	public static final RegistryObject<MobEffect> widening = RegistryObject.of(new ResourceLocation("sizeshiftingpotions:widening"), ForgeRegistries.MOB_EFFECTS);
	public static final RegistryObject<MobEffect> thinning = RegistryObject.of(new ResourceLocation("sizeshiftingpotions:thinning"), ForgeRegistries.MOB_EFFECTS);
