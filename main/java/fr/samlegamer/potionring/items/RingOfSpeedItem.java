...
public class RingOfSpeedItem extends Item implements ICurioItem
{
	...
	public void curioTick(String identifier, int index, LivingEntity livingEntity, ItemStack stack)
	{
		...
		{
            EffectInstance effectInstance = new EffectInstance(Effects.MOVEMENT_SPEED, Integer.MAX_VALUE, 0, true, false);
		...
		{
            EffectInstance effectInstance = new EffectInstance(Effects.MOVEMENT_SPEED, Integer.MAX_VALUE, 1, true, false);
            if(livingEntity.level.isClientSide) effectInstance.getDuration();
            livingEntity.addEffect(effectInstance);
		}
	}
