...
public class RingOfJumpBoostItem extends Item implements ICurioItem
{	
	public RingOfJumpBoostItem(Properties p_i48487_1_)
	{
		super(p_i48487_1_);
	}
	...
	{		
		...
		{
            EffectInstance effectInstance = new EffectInstance(Effects.JUMP, Integer.MAX_VALUE, 0, true, false);
		...
		{
            EffectInstance effectInstance = new EffectInstance(Effects.JUMP, Integer.MAX_VALUE, 1, true, false);
            if(livingEntity.level.isClientSide) effectInstance.getDuration();
            livingEntity.addEffect(effectInstance);
		}
	}
    ...
    {
    	return livingEntity.removeEffect(Effects.JUMP);
    }
}