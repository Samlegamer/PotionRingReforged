...
public class RingOfResistanceItem extends Item implements ICurioItem
{
	public RingOfResistanceItem(Properties p_i48487_1_)
	{
		super(p_i48487_1_);
	}
	...
	public void curioTick(String identifier, int index, LivingEntity livingEntity, ItemStack stack)
	{
		...
		{
            EffectInstance effectInstance = new EffectInstance(Effects.DAMAGE_RESISTANCE, Integer.MAX_VALUE, 0, true, false);
		...
		{
            EffectInstance effectInstance = new EffectInstance(Effects.DAMAGE_RESISTANCE, Integer.MAX_VALUE, 1, true, false);
            if(livingEntity.level.isClientSide) effectInstance.getDuration();
            livingEntity.addEffect(effectInstance);
		}
	}
