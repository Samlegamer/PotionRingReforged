...
public class PRLang extends LanguageProvider
{
    ...
    protected void addTranslations() {
        ...
        add(BuiltInRegistries.ITEM.get(Identifier.fromNamespaceAndPath("potionring", "ring_of_example_effect")).get().value(), "Ring of Example Effect");
        add(BuiltInRegistries.ITEM.get(Identifier.fromNamespaceAndPath("potionring", "ring_of_another_effect")).get().value(), "Ring of Another Effect");

        add(BuiltInRegistries.ITEM.get(Identifier.fromNamespaceAndPath("potionring", "ring_of_growing")).get().value(), "Ring of Growing");
        add(BuiltInRegistries.ITEM.get(Identifier.fromNamespaceAndPath("potionring", "ring_of_shrinking")).get().value(), "Ring of Shrinking");
        add(BuiltInRegistries.ITEM.get(Identifier.fromNamespaceAndPath("potionring", "ring_of_thinning")).get().value(), "Ring of Thinning");
        add(BuiltInRegistries.ITEM.get(Identifier.fromNamespaceAndPath("potionring", "ring_of_widening")).get().value(), "Ring of Widening");
    }
}
