...
public class PRLang extends FabricLanguageProvider
{
    ...
    public void generateTranslations(HolderLookup.Provider registryLookup, TranslationBuilder translationBuilder)
    {
        ...
        translationBuilder.add(BuiltInRegistries.ITEM.getKey(BuiltInRegistries.ITEM.get(Identifier.fromNamespaceAndPath("potionring", "ring_of_example_effect")).get().value()), "Ring of Example Effect");
        translationBuilder.add(BuiltInRegistries.ITEM.getKey(BuiltInRegistries.ITEM.get(Identifier.fromNamespaceAndPath("potionring", "ring_of_another_effect")).get().value()), "Ring of Another Effect");

        translationBuilder.add(BuiltInRegistries.ITEM.getKey(BuiltInRegistries.ITEM.get(Identifier.fromNamespaceAndPath("potionring", "ring_of_growing")).get().value()), "Ring of Growing");
        translationBuilder.add(BuiltInRegistries.ITEM.getKey(BuiltInRegistries.ITEM.get(Identifier.fromNamespaceAndPath("potionring", "ring_of_shrinking")).get().value()), "Ring of Shrinking");
        translationBuilder.add(BuiltInRegistries.ITEM.getKey(BuiltInRegistries.ITEM.get(Identifier.fromNamespaceAndPath("potionring", "ring_of_thinning")).get().value()), "Ring of Thinning");
        translationBuilder.add(BuiltInRegistries.ITEM.getKey(BuiltInRegistries.ITEM.get(Identifier.fromNamespaceAndPath("potionring", "ring_of_widening")).get().value()), "Ring of Widening");
    }
}