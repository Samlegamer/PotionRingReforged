...
//                .texture("layer2", modid + ":item/gem_light");
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator)
    {
        ...
        addRingModel(itemModelGenerator, Registries.ITEM.get(new Identifier("potionring", "ring_of_example_effect")));
        addRingModel(itemModelGenerator, Registries.ITEM.get(new Identifier("potionring", "ring_of_another_effect")));

        addRingModel(itemModelGenerator, Registries.ITEM.get(new Identifier("potionring", "ring_of_growing")));
        addRingModel(itemModelGenerator, Registries.ITEM.get(new Identifier("potionring", "ring_of_shrinking")));
        addRingModel(itemModelGenerator, Registries.ITEM.get(new Identifier("potionring", "ring_of_thinning")));
        addRingModel(itemModelGenerator, Registries.ITEM.get(new Identifier("potionring", "ring_of_widening")));
    }
}
