...
public class PotionRingItemModded extends Item implements ICurioItem
{
    ...
    private void AddEffect(LivingEntity livingEntity, MobEffect mbEff)
    {
		...
		{
			MobEffectInstance effectInstance = new MobEffectInstance(mbEff, 240, CuriosApi.getCuriosInventory(livingEntity).resolve().get().findCurios(this).size() - 1, true, true);
