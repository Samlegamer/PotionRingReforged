...
public class PotionRing
{
	...
	public static final MobEffect growing = BuiltInRegistries.MOB_EFFECT.get(ResourceLocation.fromNamespaceAndPath("sizeshiftingpotions", "growing"));
	public static final MobEffect shrinking = BuiltInRegistries.MOB_EFFECT.get(ResourceLocation.fromNamespaceAndPath("sizeshiftingpotions", "shrinking"));
	public static final MobEffect widening = BuiltInRegistries.MOB_EFFECT.get(ResourceLocation.fromNamespaceAndPath("sizeshiftingpotions", "widening"));
	public static final MobEffect thinning = BuiltInRegistries.MOB_EFFECT.get(ResourceLocation.fromNamespaceAndPath("sizeshiftingpotions", "thinning"));
