...
public class PRGetColorCommand
{
    ...
    private static int getColor(CommandSourceStack commandSource, Holder.Reference<MobEffect> effect) throws CommandSyntaxException {
        ...
        if(effect != null) {
            ...
            Component copy = ComponentUtils.wrapInSquareBrackets((Component.literal(hexColor)).withStyle((p_211752_2_) -> p_211752_2_.withColor(ChatFormatting.GREEN).withClickEvent(new ClickEvent.CopyToClipboard(String.valueOf(color))).withHoverEvent(new HoverEvent.ShowText(Component.translatable("chat.copy.click"))).withInsertion(hexColor)));
