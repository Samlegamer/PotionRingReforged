...
public class PRTags extends FabricTagProvider<Item>
{
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        getOrCreateTagBuilder(PRTagsItemRegistry.POTION_RINGS).add(PRItemsRegistry.POTION_RING,
                ...
                Registries.ITEM.get(new Identifier(PotionRing.MODID, "ring_of_growing")),
                Registries.ITEM.get(new Identifier(PotionRing.MODID, "ring_of_shrinking")),
                Registries.ITEM.get(new Identifier(PotionRing.MODID, "ring_of_thinning")),
                Registries.ITEM.get(new Identifier(PotionRing.MODID, "ring_of_widening"))
        );
    }
}