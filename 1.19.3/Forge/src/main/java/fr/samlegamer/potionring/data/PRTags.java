...
{
    public PRTags(PackOutput p_255871_, CompletableFuture<HolderLookup.Provider> p_256035_, @Nullable ExistingFileHelper existingFileHelper) {
        super(p_255871_, p_256035_, new PRBlockTags(p_255871_, p_256035_, existingFileHelper), PotionRing.MODID, existingFileHelper);
    }
