...
public class PRClient implements ClientModInitializer
{
    ...
    public void onInitializeClient()
    {
        ...
        setColorToRing(Registries.ITEM.get(Identifier.of(PotionRing.MODID, "ring_of_growing")), 14289002);
        setColorToRing(Registries.ITEM.get(Identifier.of(PotionRing.MODID, "ring_of_shrinking")), 13411432);
        setColorToRing(Registries.ITEM.get(Identifier.of(PotionRing.MODID, "ring_of_thinning")), 14922751);
        setColorToRing(Registries.ITEM.get(Identifier.of(PotionRing.MODID, "ring_of_widening")), 11796418);
