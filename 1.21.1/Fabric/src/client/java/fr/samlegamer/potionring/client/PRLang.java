...
{
    public PRLang(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup wrapperLookup, TranslationBuilder translationBuilder)
    {
        ...
        translationBuilder.add(Registries.ITEM.get(Identifier.of("potionring", "ring_of_example_effect")), "Ring of Example Effect");
        translationBuilder.add(Registries.ITEM.get(Identifier.of("potionring", "ring_of_another_effect")), "Ring of Another Effect");

        translationBuilder.add(Registries.ITEM.get(Identifier.of("potionring", "ring_of_growing")), "Ring of Growing");
        translationBuilder.add(Registries.ITEM.get(Identifier.of("potionring", "ring_of_shrinking")), "Ring of Shrinking");
        translationBuilder.add(Registries.ITEM.get(Identifier.of("potionring", "ring_of_thinning")), "Ring of Thinning");
        translationBuilder.add(Registries.ITEM.get(Identifier.of("potionring", "ring_of_widening")), "Ring of Widening");
    }
}