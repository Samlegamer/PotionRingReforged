...
public class PRLang extends LanguageProvider
{
    ...
    protected void addTranslations() {
        ...
        Item example_ring = BuiltInRegistries.ITEM.get(new ResourceLocation("potionring", "ring_of_example_effect"));
        Item another_ring = BuiltInRegistries.ITEM.get(new ResourceLocation("potionring", "ring_of_another_effect"));
